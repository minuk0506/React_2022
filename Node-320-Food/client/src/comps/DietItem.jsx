...
const DietItem = (food) => {
  /*
     식품명 표시 된 곳을 click 했을때 input box 가 나타나도록 하려고 한다
     1. DietList에서 isEdit state 변수를 만들고 item 을 생성하면서
     isEdit 변수의 상태에 따라 input box 또는 그냥 문자열이 나타나도록 하였다
     ==> 모든 item 이 isEdit 상태를 공유하게 되어 한개의 항목을 클릭하면
     모든 항목에 input box가 나왔다
  ...
  const removeEvent = (e, d_id) => {
    ...
    // 그중 confirm 함수도 자체 지원이 되지 않아 browser 의 함수를
